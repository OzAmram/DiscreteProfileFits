...
MASSES = [15, 35, 55, 75]
SHAPES = {
    "fit":    "signal_fits/2B_loosemass/sig_fit_{M}.json",
    "interp": "signal_fits/2B_loosemass/case_interpolation_M{M}.0.json",
}
...
def run_one(job):
    ...
    cmd = [
        sys.executable, os.path.join(FRAMEWORK_DIR, "doFit.py"), "-c", "dimuonX_config.json",
